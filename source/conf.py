# -*- coding: utf-8 -*-
#
# EgFreeCAD documentation build configuration file
# Note that not all possible configuration values are present in this
# autogenerated  (then modified) file.
#
...
sys.path.insert(0,'/usr/lib/' + FC + '/lib')

# possibly Draft can be removed but currently using in foil
sys.path.insert(0,'/usr/share/' + FC + '/Mod/Draft/')
...
rst_prolog += '\n\n'  +  '.. |FCversion| replace:: %s' %  FreeCAD.Version()
...
htmlhelp_basename = 'EgFreeCADdoc'
...
latex_documents = [
    (master_doc, 'EgFreeCAD.tex', u'EgFreeCAD Documentation',
     u'Paul Gilbert', 'manual'),
]
...
man_pages = [
    (master_doc, 'EgFreeCAD', u'EgFreeCAD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EgFreeCAD', u'EgFreeCAD Documentation',
     author, 'EgFreeCAD', 'Example FreeCAD scripting with doctest checking.',
     'Miscellaneous'),
]
